    ...
    <div>
                                ...
                                >
                                    <div class="modal-body pb-3 px-sm-3">
                                        ...
                                        <small class="text-info"
                                            >After sending any payment in crypto
                                            wallet, u will recieve transaction
                                            hash, add it in this field to get
                                            verified in the blockchain to
                                            recieve your balance.</small
                                        >
                                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form class="add-new-record modal-content pt-0">
                            <div class="modal-body pb-3 px-sm-3">
                                ...
                                <hr />
                                <div class="input-group">
                                    <span class="input-group-text" for="address"
                            ...
                            <div class="modal-body pb-3 px-sm-3">
                                ...
                                <div class="input-group my-1">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        v-model="withdraw_amount"
                                        :min="currency.min_withdrawal_amount"
                                    />
                                </div>
                                <div class="my-1">
                                    <div class="input-group">
        ...
        >
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-transparent">
                        <h5 class="modal-title">Trading To Funding Transfer</h5>
                        <button
                            type="button"
                            class="btn-close"
                            data-bs-dismiss="modal"
        ...
        >
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-transparent">
                        <h5 class="modal-title">Funding To Trading Transfer</h5>
                        <button
                            type="button"
                            class="btn-close"
                            data-bs-dismiss="modal"
