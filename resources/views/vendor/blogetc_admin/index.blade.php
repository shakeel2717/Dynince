                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                            ...
                            {!! $post->is_published
                                ? '<div class="badge rounded-pill bg-success fs-6">Published</div>'
                                : '<div class="badge rounded-pill bg-danger fs-6">Not Published</div>' !!}
                        </h4>
                        ...
                        <div class="my-1 py-25">
                            @if (count($post->categories))
                                @foreach ($post->categories as $category)
                                    <a href="{{ route('admin.blogetc.admin.categories.edit_category', $category->id) }}">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
                            <a class="col-sm-4 btn btn-primary btn-sm" href="{{ $post->url() }}" class="fw-bold">View
                                Post</a>
                            <a class="col-sm-4 btn btn-info btn-sm"
                                href="{{ route('admin.blogetc.admin.edit_post', $post->id) }}" class="fw-bold">Edit
                                Post</a>
                            <form
