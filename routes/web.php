...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'role:admin,demo', 'prefix' => 'admin', 'namespace' => 'Admin', 'as' => 'admin.'], function () {
        ...
        Route::group(['prefix' => 'blog_admin', 'as' => 'blogetc.'], function () {
            Route::get('/', 'ManagePostsController@index')->name('admin.index');
            Route::get('/add_post', 'ManagePostsController@create')->name('admin.create_post');
            Route::post('/add_post', 'ManagePostsController@store')->name('admin.store_post')->middleware('demo');
            Route::get('/edit_post/{blogPostId}', 'ManagePostsController@edit')->name('admin.edit_post');
            Route::patch('/edit_post/{blogPostId}', 'ManagePostsController@update')->name('admin.update_post');
            Route::group(['prefix' => 'image_uploads'], static function () {
                Route::get('/', 'ManageUploadsController@index')->name('admin.images.all');
                Route::get('/upload', 'ManageUploadsController@create')->name('admin.images.upload');
                Route::post('/upload', 'ManageUploadsController@store')->name('admin.images.store')->middleware('demo');
                Route::get('/post/{postId}/delete-images', 'ManageUploadsController@deletePostImage')->name('admin.images.delete-post-image');
                Route::delete('/post/{postId}/delete-images', 'ManageUploadsController@deletePostImageConfirmed')->name('admin.images.delete-post-image-confirmed');
            });
            Route::delete('/delete_post/{blogPostId}', 'ManagePostsController@destroy')->name('admin.destroy_post');
            Route::group(['prefix' => 'comments'], static function () {
                Route::get('/', 'ManageCommentsController@index')->name('admin.comments.index');
                Route::patch('/{commentId}', 'ManageCommentsController@approve')->name('admin.comments.approve');
                Route::delete('/{commentId}', 'ManageCommentsController@destroy')->name('admin.comments.delete');
            });
            Route::group(['prefix' => 'categories'], static function () {
                Route::get('/', 'ManageCategoriesController@index')->name('admin.categories.index');
                Route::get('/add_category', 'ManageCategoriesController@create')->name('admin.categories.create_category');
                Route::post('/add_category', 'ManageCategoriesController@store')->name('admin.categories.store_category')->middleware('demo');
                Route::get('/edit_category/{categoryId}', 'ManageCategoriesController@edit')->name('admin.categories.edit_category');
                Route::patch('/edit_category/{categoryId}', 'ManageCategoriesController@update')->name('admin.categories.update_category');
                Route::delete('/delete_category/{categoryId}', 'ManageCategoriesController@destroy')->name('admin.categories.destroy_category');
            });
        });
